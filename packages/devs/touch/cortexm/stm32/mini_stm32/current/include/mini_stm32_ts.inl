...
#define CYGHWR_HAL_MINI_STM32_TOUCH_PEN_IRQ  CYGHWR_HAL_STM32_GPIO( B, 6,  IN, PULLUP )

static int mini_stm32_get_pen_down( void ){
   int state;
   hal_stm32_gpio_in(CYGHWR_HAL_MINI_STM32_TOUCH_PEN_IRQ, &state);
   return state;
}
