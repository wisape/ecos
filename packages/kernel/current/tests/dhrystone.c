...
# if !defined(CYGFUN_KERNEL_API_C) \
    ...
    || !defined(CYGPKG_LIBC_STARTUP)

#  define NA_MSG "Requires CYGPKG_LIBC_STARTUP && CYGFUN_KERNEL_API_C && CYGINT_ISO_STDIO_FORMATTED_IO && CYGINT_ISO_MALLOC && CYGINT_ISO_STRING_STRFUNCS"
