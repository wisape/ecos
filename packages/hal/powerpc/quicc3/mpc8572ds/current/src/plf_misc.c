...
// Contributors:
// Date:        
// Purpose:     Miscellaneous functions for Freescale MPC8572DS board
// Description: 
//
//####DESCRIPTIONEND####
//
...
void hal_clock_initialize_gta0(cyg_uint32 period)
{
  ...
  // Disable counter
  HAL_WRITE_UINT32(CYGARC_IMM_BASE+CYGARC_REG_IMM_PIC+CYGARC_REG_IMM_GTBCRA0, CYGARC_REG_IMM_GTCCR_CI);

  // Load the period and enable interrupt
  HAL_WRITE_UINT32(CYGARC_IMM_BASE+CYGARC_REG_IMM_PIC+CYGARC_REG_IMM_GTBCRA0, period);
...
void hal_clock_read_gta0(cyg_uint32 *pvalue)
{
  ...
  HAL_READ_UINT32(timer+CYGARC_REG_IMM_GTCCRA0, val);
  *pvalue = val;
}
...
void hal_clock_initialize_gtb0(cyg_uint32 period)
{
  ...
  // Disable counter
  HAL_WRITE_UINT32(CYGARC_IMM_BASE+CYGARC_REG_IMM_PIC+CYGARC_REG_IMM_GTBCRB0, CYGARC_REG_IMM_GTCCR_CI);

  // Load the period and enable interrupt
  HAL_WRITE_UINT32(CYGARC_IMM_BASE+CYGARC_REG_IMM_PIC+CYGARC_REG_IMM_GTBCRB0, period);
...
void hal_clock_read_gtb0(cyg_uint32 *pvalue)
{
  ...
  HAL_READ_UINT32(timer+CYGARC_REG_IMM_GTCCRB0, val);
  *pvalue = val;
}
