...
#endif
#define CYGMEM_REGION_ram (0x00100000) /* First MB is ROMRAM boot code */
#define CYGMEM_REGION_ram_SIZE (0x40000000)  /* 1024MB */
...
#define CYGMEM_SECTION_reserved_for_rom_SIZE (0xfcd00)
#ifndef __ASSEMBLER__
extern char CYG_LABEL_NAME (__heap1) [];
#endif
#define CYGMEM_SECTION_heap1 (CYG_LABEL_NAME (__heap1))
#define CYGMEM_SECTION_heap1_SIZE (0x40000000 - (size_t) CYG_LABEL_NAME (__heap1))
