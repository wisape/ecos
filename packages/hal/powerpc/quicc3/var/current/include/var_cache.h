...
// Date:         2009-11-01
// Purpose:      
// Description:  Variant HAL cache control API for Freescale Quicc III target
...
// Cache dimensions
        ...
        defined(CYGHWR_HAL_POWERPC_QUICC3_MPC8544E) ||  \
...
#else
# error "Don't know the QUICC3 cache size"
#endif
...
#define HAL_ICACHE_ENABLE()                 \
    ...
    asm volatile (                          \
        ...
        : "r" (tmp), "I" (CYGARC_REG_L1CSR1),  \
          ...
          "I" (CYGARC_REG_L1CSR1_ICPE>>16) /* %1 ==> L1CSR1 */); \
    CYG_MACRO_END
