...
init_serial_channel(channel_data_t* __ch_data)
{
    ...
    cyg_uint8 lcr;
    cyg_uint16 baud_divisor =  (cyg_uint16)(((cyg_uint32)(CYGHWR_HAL_POWERPC_QORIQ_PLF_CLK/2)) / ((cyg_uint32)(CYGNUM_HAL_VIRTUAL_VECTOR_CONSOLE_CHANNEL_BAUD) * 16));
...
static channel_data_t channels[2] = {
    ...
    { (cyg_uint8*)(CYGARC_IMM_BASE + UART3_OFFSET), 1000, CYGNUM_HAL_INTERRUPT_UART2}
#endif
};
