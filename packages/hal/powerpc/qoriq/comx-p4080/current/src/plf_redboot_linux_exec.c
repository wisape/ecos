...
{
    board_info->bi_intfreq  = CYGHWR_HAL_POWERPC_CPU_SPEED;
    board_info->bi_busfreq  = CYGHWR_HAL_POWERPC_QORIQ_DDR_CLK;
    board_info->bi_cpmfreq  = CYGHWR_HAL_POWERPC_QORIQ_PLF_CLK;
    board_info->bi_brgfreq      = ((CYGHWR_HAL_POWERPC_QORIQ_PLF_CLK*2))/16;
    board_info->bi_immr         = CYGARC_IMM_BASE;
    board_info->bi_flashbase    = 0xe8000000;
    board_info->bi_flashsize    = 0x08000000;
