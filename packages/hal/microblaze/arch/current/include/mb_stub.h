#ifndef CYGONCE_HAL_STUB_H
#define CYGONCE_HAL_STUB_H
/*==========================================================================
//
//      md_stub.h
//
//      Microblaze GDB stub support
//
//==========================================================================
...
#define HAL_STUB_REGISTERS_SIZE \
 ((sizeof(HAL_MB_GDB_Registers) + sizeof(target_register_t) - 1) / sizeof(target_register_t))
...
//==========================================================================
#endif // ifndef CYGONCE_HAL_STUB_H
